...
public class GrammarParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'}'", "'else'", "'while'", "'return'", "'INTEGER'", "'REAL'", "'CHARACTER'"
		};
	}
	...
	public final FeatureDefinitionContext featureDefinition() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 135216703062704128L) != 0) {
					{
					{
					setState(103);
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 135107988850507776L) != 0) {
				{
				setState(268);
