...
public class TypeChecking extends DefaultVisitor {
   ...
   * <p>Usage examples:
   *
   * <p>predicate(expr.type != null), "Type cannot be null", expr.start());
   *
   * <p>predicate(expr.type != null), "Type cannot be null", expr); // expr.start() is assumed
   *
   * <p>The start() method (example 1) indicates the position in the file where the node was. If
   * VGen is used, this method will have been generated in all AST nodes.
   *
