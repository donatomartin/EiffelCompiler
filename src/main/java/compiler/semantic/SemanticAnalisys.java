...
/**
 * This class coordinates the two main phases of Semantic Analysis: 1. Identification phase. 2. Type
 * Checking phase.
 *
 * <p>It is not necessary to modify this class. Instead, you should modify the classes that are
 * called from here: "Identification.java" and "TypeChecking.java".
 */
public class SemanticAnalisys {
  ...
  public void analize(AST ast) {
    ...
    if (errorManager.errorsCount() > 0) return;
