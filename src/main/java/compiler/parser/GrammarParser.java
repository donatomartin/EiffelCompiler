...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, T__48=49, T__49=50, LINE_COMMENT=51, MULTILINE_COMMENT=52, 
		WHITESPACE=53, INT_LITERAL=54, REAL_LITERAL=55, CHAR_LITERAL=56, IDENT=57;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'then'", "'else'", "'until'", "'loop'", "'return'", "'from'", "'INTEGER'", 
			"'DOUBLE'", "'CHARACTER'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "LINE_COMMENT", "MULTILINE_COMMENT", "WHITESPACE", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			setState(59);
			match(EOF);
			((ProgramContext)_localctx).ast =  new Program(((ProgramContext)_localctx).IDENT, ((ProgramContext)_localctx).globalSection.list, ((ProgramContext)_localctx).createSection.list, ((ProgramContext)_localctx).functionDefinitions, ((ProgramContext)_localctx).run.ast); 
			}
		}
		...
		try {
			...
			if (_la==T__3) {
				...
				((GlobalSectionContext)_localctx).globalTypesSection = globalTypesSection();
				 _localctx.list.addAll(((GlobalSectionContext)_localctx).globalTypesSection.list); 
				setState(65);
				((GlobalSectionContext)_localctx).globalVarsSection = globalVarsSection();
				 _localctx.list.addAll(((GlobalSectionContext)_localctx).globalVarsSection.list); 
				}
				}
			}
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 270447837186162688L) != 0) {
					{
					{
					setState(144);
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 270215977671655424L) != 0) {
				{
				setState(318);
	...
	public final FromClauseContext fromClause() throws RecognitionException {
		...
		try {
			...
			if (_la==T__46) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 270215977671655424L) != 0) {
					{
					{
					setState(427);
