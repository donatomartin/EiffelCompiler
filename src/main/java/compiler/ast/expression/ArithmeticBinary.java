...
public class ArithmeticBinary extends AbstractExpression  {
	...
	public ArithmeticBinary(Expression left, String operator, Expression right) {
		super();
	...
	public ArithmeticBinary(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "ArithmeticBinary{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
